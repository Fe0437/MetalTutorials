...
//            descriptor.colorAttachments[Int(MT6RenderTargetAlbedo.rawValue)]?.pixelFormat = albedoDesc.pixelFormat
//            descriptor.colorAttachments[Int(MT6RenderTargetNormal.rawValue)]?.pixelFormat = gBufferTextureDesc.pixelFormat
//            descriptor.colorAttachments[Int(MT6RenderTargetDepth.rawValue)]?.pixelFormat = gBufferTextureDesc.pixelFormat
...
//            
//            commandEncoder.setVertexBytes(&uniforms.0, length: MemoryLayout<MT6VertexUniforms>.size, index: 1)
...
//            descriptor.colorAttachments[Int(MT6RenderTargetAlbedo.rawValue)].loadAction = .clear
//            // tutorial 5 - tiled rendering
//            descriptor.colorAttachments[Int(MT6RenderTargetAlbedo.rawValue)].storeAction = .dontCare
//            descriptor.colorAttachments[Int(MT6RenderTargetAlbedo.rawValue)].texture = _gBuffer.albedoSpecular
//            
//            descriptor.colorAttachments[Int(MT6RenderTargetNormal.rawValue)].loadAction = .clear
//            descriptor.colorAttachments[Int(MT6RenderTargetNormal.rawValue)].storeAction = .dontCare
//            descriptor.colorAttachments[Int(MT6RenderTargetNormal.rawValue)].texture = _gBuffer.normal
//            
//            descriptor.colorAttachments[Int(MT6RenderTargetDepth.rawValue)].loadAction = .clear
//            descriptor.colorAttachments[Int(MT6RenderTargetDepth.rawValue)].storeAction = .dontCare
//            descriptor.colorAttachments[Int(MT6RenderTargetDepth.rawValue)].texture = _gBuffer.depth
//            
//            descriptor.depthAttachment.loadAction = .clear
...
//                
//                commandEncoder.setVertexBytes(&uniforms.0, length: MemoryLayout<MT6VertexUniforms>.size, index: 1)
//                commandEncoder.setFragmentBytes(&uniforms.1, length: MemoryLayout<MT6FragmentUniforms>.size, index: 1)
//                commandEncoder.setFragmentTexture(_shadowTexture, index: Int(MT6RenderTargetShadow.rawValue))
//                
...
//                _renderMeshes(commandEncoder)
//                
//                commandEncoder.setVertexBytes(&planeUniforms.0, length: MemoryLayout<MT6VertexUniforms>.size, index: 1)
//                commandEncoder.setFragmentBytes(&planeUniforms.1, length: MemoryLayout<MT6FragmentUniforms>.size, index: 1)
//                
...
//                                               offset: 0,
//                                               index: Int(MT6BufferIndexMeshPositions.rawValue))
...
//    }
//    
//    private func _buildUniforms(_ view:MTKView, modelMatrix : float4x4?) -> (MT6VertexUniforms, MT6FragmentUniforms)
//    {
...
//        guard let icb = _device.makeIndirectCommandBuffer(
//          descriptor: desc,
//          maxCommandCount: 1, // 1 only object right now
//          options: []) else { fatalError("Failed to create ICB") }
//        self._indirectBuffer = icb
//        
//        for (index, mesh) in _meshes.enumerated() {
//            let commandEncoder = icb.indirectRenderCommandAt(index)
//            let vertexBuffer = mesh.vertexBuffers.first!
//            //[[attribute(0)]]
//            commandEncoder.setVertexBuffer(vertexBuffer.buffer, offset: vertexBuffer.offset, index: 0)
//            
...
//    var _uniformsBuffer: MTLBuffer!
//    var _indirectBuffer: MTLIndirectCommandBuffer!
//    
//    //tutorial 4 - Shadows
