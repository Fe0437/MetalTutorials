...
#include "MT4Uniforms.h"
#include "MT4RenderTargets.h"
...
namespace MT4 {
    ...
    fragment GBuffer gbuffer_fragment(
                                             ...
                                             depth2d<float> shadowTexture [[ texture(MT4RenderTargetShadow) ]], // < depth2d not texture
    ...
    vertex QuadInOut
    display_vertex(constant MT4ScreenVertex * vertices  [[ buffer(MT4BufferIndexMeshPositions) ]],
                       uint                        vid       [[ vertex_id ]])
    {
        QuadInOut out;
